...
public class ArraysTest extends AbstractElementProcessorTestCase {
    ...
    public void testProcessesTwoDimensionalArray() throws Exception {
        ConstructorParam aCustomDate = builderMetadata.parameters.get(11);
